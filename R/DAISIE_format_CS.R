#' Formats oceanic clade-specific simulation output into standard
#' DAISIE list output
#'
...
DAISIE_format_CS_oceanic = function(island_replicates,time,M,sample_freq, start_midway = FALSE, verbose = TRUE)
{
  totaltime <- time
...
#' Formats nonoceanic clade-specific simulation output into standard
#' DAISIE list output
#'
#' @param island_replicates Int stating number of replicates.
#' @param time Numeric double with total time of simulation.
...
#'
#' @return List with CS DAISIE simulation output
DAISIE_format_CS_nonoceanic = function(island_replicates,time,M,sample_freq, start_midway = FALSE, verbose = TRUE)
{
  totaltime <- time
  several_islands = list()
