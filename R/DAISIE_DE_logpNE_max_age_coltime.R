...
#'
#' @return The output is a numeric value representing the log-likelihood of observing a non-endemic singleton lineage at time t1.
...
#' log_likelihood <- DAISIE_DE_logpNE_max_age_coltime(datalist, brts = datalist[[i]]$branching_times, pars1, missnumspec = datalist[[i]]$missing_species, methode = "lsodes", reltolint = 1e-16, abstolint = 1e-16)
#'
