...
{
  Galapagos_datalist = NULL; rm(Galapagos_datalist)
  ...
  pars2 = c(40,11,0,0)
  SR_loglik_CS = DAISIE_SR_loglik_CS(pars1 = pars1,pars2 = pars2,datalist = Galapagos_datalist, methode = 'ode45', CS_version = 1)
  pars1 = c(0.2,0.1,Inf,0.001,0.3)
  loglik_CS = DAISIE_loglik_CS(pars1 = pars1,pars2 = pars2,datalist = Galapagos_datalist, methode = 'ode45', CS_version = 1)
  testthat::expect_equal(SR_loglik_CS,loglik_CS)
    
  utils::data(Galapagos_datalist, package = "DAISIE")
  pars1 = c(0.2,0.1,Inf,0.001,0.3)
  pars2 = c(40,11,0,0)
  loglik_IW = DAISIE_loglik_IW(pars1 = pars1,pars2 = pars2,datalist = Galapagos_datalist, methode = 'ode45')
  loglik_CS = loglik_CS
