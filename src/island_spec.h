...
struct island_spec_row {
  ...
  void set_extinction_time(double e) {
    extinction_time = e;
  }
  double get_extinction_time() {
...
struct island_spec {
  ...
  void clado_genesis_c(const size_t& index,
  ...
  void clado_genesis_not_c(const size_t& index,
   ...
   // data_[index].extinction_time = data_[index].colonisation_time;
    data_[index].set_extinction_time(data_[index].colonisation_time);
    data_[index].ext_type = none;
