...
```
```{r fig.width=5, fig.height=5}
DAISIE_plot_sims(island_replicates = TRASIE1_trans3,Tpars = Tpars1_trans3, use_dev_new = FALSE)
```
...
compare <- compare_diff(DAISIE_output = DAISIE_ave,
                       ...
                       TRASIE_output4 = TRASIE1_trans3,
                       Tpars1 = Tpars1_notrans,
                       Tpars2 = Tpars1_trans1,
                       Tpars3 = Tpars1_trans2,
                       Tpars4 = Tpars1_trans3)
```



Testing the influence of rates deviation between two trait states
...
Tpars3 <- create_trait_state_params(
     ...
     trans_rate2 = 0,
     M2 = n_mainland_species)
Tpars_unbalM <- create_trait_state_params(
     trans_rate = 0,
     immig_rate2 = imm_rate * 1.9,
     ext_rate2 = ext_rate * 1.9,
     ana_rate2 = ana_rate * 1.9,
...
```
```{r fig.width=5, fig.height=5}
DAISIE_plot_sims(island_replicates = TRASIE4,Tpars = Tpars_unbalM, use_dev_new = FALSE)
```
