...
-   How do speciation, extinction and colonisation rates vary with island area and isolation on a global scale? Example: birds of oceanic islands archipelagos worldwide ([Valente et al 2020](https://doi.org/10.1038/s41586-020-2022-5)).
...
Island age estimates can be obtained from the biogeographical or geological literature (e.g. see the Methods section of [Valente et al 2020](https://doi.org/10.1038/s41586-020-2022-5) for the sources of the island ages used there).
