...
- DAISIE includes an updated DAISIE_DE which allows for a faster
  computation of the likelihood when the clade-level carrying capacity K
  is infinite. DAISIE_DE allowed for identifying bugs in the original
  DAISIE code which have now been fixed.
