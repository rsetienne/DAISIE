...
Eleutherodactylus frogs of Hispaniola. Main dataset used in Etienne et
al. This list can be generated using the DAISIE_dataprep function, which
converts a user-specified data table into a data object, but the object
can of course also be entered directly. It is an R list object with the
following elements.  
...
A list with 6 elements, the first of which contains 2 elements and the
following 5 elements containing 5 components.

## Source

Etienne RS, Haegeman B, Dugo-Cota A, Vila C, Gonzalez-Voyer A & Valente
L. The limits to ecological limits to diversification.  
