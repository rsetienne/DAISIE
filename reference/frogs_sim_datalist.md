...
A list containing the colonization and branching times of a simulated
data set using the MLE parameters of IW model for the frogs_datalist. It
is an R list object with the following elements.  
...
A list with the first element containing 2 elements and the following
