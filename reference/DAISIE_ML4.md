...
where one parameter may vary over the clades governed by a specific
distribution
...
- sd:
  ...
  gives the maximum likelihood estimate of the standard deviation for
  the parameter which is allowed to vary
